        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Ruangan Anda</p>
                            <h1 class="font-weight-bolder">
                                <?= $ruangan; ?>
                            </h1>
                        </div>
                ...
                <div class="card-header pb-0 pt-3 mb-3 bg-transparent">
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <p>Aplikasi Absensi Kemahasiswaan adalah perangkat lunak yang digunakan untuk mencatat
                                kehadiran
                                atau ketidakhadiran seseorang dalam suatu kegiatan, seperti kelas, pertemuan, atau
                                acara.
                                Aplikasi ini dirancang dengan tujuan utama untuk memberikan wadah yang efisien dan
                                efektif
