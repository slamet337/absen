...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url('') ?>/assets/logo.png">
  ...
  <link id="pagestyle" href="<?= base_url('') ?>/assets/admin/css/Argon-dashboard.min.css?v=2.0.4" rel="stylesheet" />
